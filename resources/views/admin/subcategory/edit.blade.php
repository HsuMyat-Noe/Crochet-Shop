                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-primary">
                            <form action="{{ url('admin/subcategory/edit/'.$getRecord->id) }}" method="POST">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('subcategory_name', $getRecord->name) }}" name="subcategory_name" placeholder="Enter Name" required>
                                    </div>
